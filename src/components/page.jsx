                    ...
                    <div className="o_card flex mt-2 flex-wrap justify-between">
                        {
                            ...
                            return <a href="https://github.com/abhishekshelar126200/Music-Recommendation/songs"><div key={index} className="card relative p-2 rounded-md mb-3 header hover:bg-[#313131] hover:w-[10.1rem] group" onClick={()=>playMusic(nam,poster)} >
